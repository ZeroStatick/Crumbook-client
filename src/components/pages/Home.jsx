                ...
                >
                  <div className="p-6">
                    <div className="mb-4 flex flex-wrap gap-2">
                      ...
                      {recipe.avgRating > 0 && (
                        <span className="inline-flex items-center gap-1 rounded-full border border-amber-400/20 bg-amber-400/10 px-3 py-1 text-[10px] font-semibold tracking-[0.18em] text-amber-200 uppercase">
                          <svg
