              ...
              >
                <div className="p-4">
                  <div className="relative overflow-hidden rounded-[1rem] border border-white/10 bg-black">
                    ...
                    {recipe.avgRating > 0 && (
                      <div className="absolute top-3 left-3 z-10 inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-black/40 px-3 py-1.5 text-[10px] font-black tracking-widest text-amber-200 uppercase backdrop-blur-md shadow-lg">
                        <svg
